...
func (src *Coord) Run() error {
	...
	fmt.Println("Round 1: got ", items, " items, thresh ", thresh, ", local thresh will be ", localthresh)
	...
	fmt.Println("Round 2: got ", round2items, " items, thresh ", secondthresh, ", unique items fetching ", len(ids))
	...
	fmt.Println("Round 3: got ", round3items, " items")
